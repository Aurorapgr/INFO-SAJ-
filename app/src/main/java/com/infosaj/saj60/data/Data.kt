...
object Data {
    val usfs : List<InfoDataConstructor> = listOf(
        InfoDataConstructor(
            ...
            aten = "Atendimento: Segunda a Sexta, das 8h às 17h",
    ...
    val instOngs : List<InfoDataConstructor> = listOf(
        InfoDataConstructor(
            ...
            aten = "Atendimento: Segunda a Sexta, das 8h às 12h e das 14h às 17h",
            addr = "Endereço:  Rua Rosalvo Fonseca, nº116, São Cristóvão, Santo Antônio de Jesus, CEP 44440812",
    ...
    val sus : List<InfoDataConstructor> = listOf(
        InfoDataConstructor(
            ...
            info = "Especialidades:\n" +
                    ...
                    "\n" +
                    "Também há a realização de endoscopia, mamografia, radiografia, ressonâncias, tomografias,\n" +
                    "colonoscopia, biopsias à pedido da ginecelogia, entre outros. ",
            docm = "",
        ...
        InfoDataConstructor(
            ...
            phone = "Telefone: (75) 3162-1400",
            email = "",
            insta = "",
            info = "",
            docm = "",
            serv = "Serviços: Realiza consulta médica em atenção especializada (cirurgia geral, gastroenterologista, bucomaxilo, " +
                    "cardiologia, pediatra e ortopedia), possui pronto socorro de neurologia/neurocirurgia, dispõe de tratamento com" +
        ...
        InfoDataConstructor(
            ...
            info = "",
            docm = "",
            serv = "Serviços: Consulta médica em atenção especializada, equipe composta por:\n" +
                    "● Pediatria\n" +
                    "● Geriatria\n" +
                    "● Ginecologia\n" +
                    "● Ortopedia\n" +
        ...
        InfoDataConstructor(
            ...
            id = 0,
            usfName = "UNACON",
            aten = "Atendimento: 24 H para situações emergênciais, enquanto a parte ambulatorial funciona de Segunda a Sexta (Horário comercial)",
            addr = "Endereço: Av. Luís Argôlo, 128 - Centro, Santo Antônio de Jesus - BA, 44572-030",
            phone = "",
            email = "",
            insta = "",
            info = "Informações: A Unidade de Alta Complexidade em Oncologia conta com Ambulatório eletivo, cirurgias eletivas e dispõe de internamento 24h.",
            docm = "Documentos: Para a primeira ida é necessário apresentar os documentos pessoais, cartão do SUS e quaisquer exames feitos. "+
                    "Pacientes são encaminhados para o serviço via secretarias municipais de saúde.",
            serv = "Serviços: Ambulatório clínico cirúrgico, cirurgias oncológicas, cirurgia reparadora, quimioterapia.\n" +
                    "\n" +
                    "A UNACON presta esses serviços à toda região macroleste de saúde, abrangendo Santo Antônio de Jesus e mais 23 municípios.",
    ...
    val servUFRB : List<InfoDataConstructor> = listOf(
        InfoDataConstructor(
            ...
            aten = "Atendimento: Segunda a Sexta das 8h  às 12h e das 13h às 17h, sendo que na sexta não funciona em turno vespertino.",
            ...
            phone = "Telefone: (71) 99104-5361",
            email = "",
            insta = "Instagram: @labcovufrb",
            info = "",
            docm = "Documentos: É necessário levar RG ou qualquer documento com foto\n" +
                    "Carteira nacional de saúde (SUS) \n" +
                    "Cartão de vacina" ,
            serv = "Serviços: Realiza testagem da COVID-19, influenza A e B e vírus respiratórios. A atividade tem cadastro no SUS. Realiza também treinamentos periódicos de capacitação para vacinas e IST’s, que são divulgados no site do CCS.\n" +
        ...
        InfoDataConstructor(
            ...
            addr = "Endereço: Avenida Carlos Amaral, R. do Cajueiro, 1015, Santo Antônio de Jesus - BA, 44574-490. UFRB -Universidade Federal do Recôncavo da Bahia",
            phone = "Telefone: (75) 3631-1196",
            email = "E-mail: servicopsi@ccs.ufrb.edu.br",
            insta = "Instagram: @ccsufrb",
            info = "",
            docm = "Documentos: É necessário RG ou qualquer documento com foto",
            serv = "Serviços: A Universidade Federal do Recôncavo da Bahia (UFRB) conta com um serviço de psicologia gratuito e aberto ao público.\n"+
                    "No momento, não há ofertas específicas para idosos, eles atendem independente da faixa etária.\n"+
                    "As modalidades podem ser realizadas de forma online, presencial, individual ou em grupo) depende do edital de cada semestre, que está disponível da página CCS-UFRB\n"+
                    "→ https://www.ufrb.edu.br/ccs/",
            team = "Equipe: Multiprofissional"
        )
    )
    val assSocial : List<InfoDataConstructor> = listOf(
        InfoDataConstructor(
            ...
            id = 0,
            usfName = "CRAS",
            aten = "Atendimento: Segunda a Sexta, das 8h às 17h, não fecha pra almoço, mas as assistentes sociais saem.",
            addr = "Endereços: \n" +
                    "Em SAJ, funcionam 4 polos:\n"+
                    "\n"+
                    "CRAS CIDADANIA: Rua Castro Alves, n° 258, próximo a escola municipal Luís Eduardo Maron de Magalhães.\n" +
                    "Telefone: (75) 3632-4912" +
                    "\n"+
                    "\n"+
                    "CRAS QUILOMBOLA: Rua Mutum de baixo, n° 190, Irmã Dulce. \n" +
                    "Telefone: (75) 3632-1690 / (75) 36312906\n" +
                    "\n"+
                    "CRAS COMUNIDADE: Rua Adilson N Neiva, Andaiá.\n" +
                    "Telefone: (75) 3632-1690"+
                    "\n"+
                    "\n"+
                    "CRAS NAZARETH ASSIS: Largo do São Benedito, n° 192, sem telefone no momento.",
            phone = "",
            email = "",
            insta = "",
            info = "Informações: \n" +
                    "O CRAS oferece proteção assistencial a pessoas com vulnerabilidade social e se impulsionam em tornar viável o acesso a projetos e benefícios." +
                    " Ele orienta seus usuários a como realizar a inscrição no cadastro único e seus serviços oferecidos tem a finalidade de melhorar a vida da comunidade" +
                    " e familiares.\n" +
                    "\n"+
                    "No CRAS é oferecido o Serviço de Proteção e Atendimento Integral à Família (PAIF) e o Serviço de Convivência e Fortalecimento de Vínculos (SCFV)," +
                    " descrito aqui no aplicativo em “Espaço Conviver”\n " +
                    "\n"+
                    "No CRAS a população também é " +
                    "orientada para saber todos os benefícios assistenciais disponíveis e podem realizar sua inscrição no " +
                    "Cadastro Único para Programas Sociais do Governo Federal.\n" +
                    "\n"+
                    "O Cadastro Único é um dos principais motivos que levam as famílias a procurar o " +
                    "atendimento na agência do CRAS. Somente com a aprovação neste sistema é possível ter " +
                    "acesso aos  receber os benefícios dos programas sociais a seguir:\n" +
                    "\n"+
                    ...
                    "● Telefone Popular\n " +
                    "\n"+
                    "Aqui em Santo Antônio de Jesus, Cada CRAS tem um centro comunitário em que ocorrem " +
                    "suas atividades, geralmente com encontros quinzenais que contam com rodas de conversas, " +
                    "artesanato, dinâmicas, entre outras coisas. Cada encontro tem um tema (como setembro " +
                    "amarelo, outubro rosa, teatro, músicas) tudo sempre muito organizado pelas orientadoras.",
            docm = "Documentos: É necessário para a primeira ida: \n" +
                    "Identidade\n" +
                    "CPF\n" +
                    "NIS\n" +
        ...
        InfoDataConstructor(
            ...
            phone = "Telefone: (75) 3632-4760",
            email = "",
            insta = "",
            info = "Informações: O atendimento é prestado no próprio CREAS ou pelo deslocamento de equipes em territórios " +
                    "e domicílios, funcionando em estreita articulação com o Poder Judiciário, Ministério Público, Defensoria Pública," +
                    " Conselhos Tutelares e outras Organizações de Defesa de Direitos, junto com os demais serviços socioassistenciais" +
                    " e de outras políticas públicas, no intuito de estruturar uma rede efetiva de proteção social, formado por psicólogos," +
                    " advogados e assistentes sociais.\n"+
                    "\n"+
                    "Uma forma também segura de ser assistida pelo CREAS é através da Casa dos Conselhos, em que há mais informações em “Conselho Municipal dos Direitos da Pessoa Idosa”",
            docm = "",
            serv = "Serviços: Dispõe de múltiplos profissionais especializados no apoio, orientação e acompanhamento a indivíduos e" +
                    " famílias em situação de ameaça ou violação de direitos. O CREAS atua quando o direito é violado e oferece acompanhamento" +
                    " especializado desenvolvido por uma equipe completa, de modo a potencializar a capacidade de proteção da família " +
        ...
        InfoDataConstructor(
            ...
            aten = "Atendimento: Segunda a Sexta, das 08h às 17h",
            addr = "Endereço: Rua Castro Alves, Centro, n°67, sentido à rua do cajueiro.",
            phone = "Telefone: indisponível no momento",
            email = "",
            insta = "Instagram: secsocialsaj \n" +
                    "\n"+
                    "Facebook: socialsaj",
            info = "",
            docm = "Documentos: É preciso estar cadastrado no CRAS de referência (o mais próximo do seu bairro), mas o espaço é aberto para visitantes",
            serv = "Serviços: Esta unidade atende diversas pessoas que estão ligadas ao CRAS e" +
                    " oferece diversas oficinas e treinamentos para fortalecer o convívio Social, tendo grupos de faixa etária diversa. \n" +
                    "\n" +
                    "As atividades podem variar de acordo com o período do ano, podendo conter Aula de Dança/Baile dos idoso, Aula de Ginastica," +
                    " pintura, crochê, bordades, damas, baralho, dominó, entre outros\n" +
                    "\n" +
                    "O espaço Conviver acompanha o público assistido e caso precise de um encaminhamento para um serviço de saúde, ele realiza.\n" +
                    "As pessoas idosas do Espaço Conviver são totalmente ativos e possuem uma comunicação muito boa com os profissionais do espaço, que sempre tenta atender suas demandas.",
            team = ""
        )
